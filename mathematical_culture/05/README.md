...
## 6 数学基础与第三次数学危机
>
- 前两次数学危机，本质上都是对当时数学基础的质疑。第三次数学危机也是数学基础崩塌以后引发的危机。
>
### 数学的基础在哪里？
>
- 19世纪末，集合论出现了。人们感觉集合论有可能成为整个数学的基础。
>
- 算术以整数、分数等为研究对象；微积分以变数、函数为研究对象；几何以点、线、面及其组合的图形为研究对象；
>
- 都是以集合为对象，集合成了更基本的概念，集合论具有数学基础的地位。
>
- 只要证明集合论没有矛盾，就可以一劳永逸地解除“数学基础”的危机。《算术基础》——弗雷格
>
- **所有的非负整数都需要用集合论的观点和语言重新定义**
>
- 空集是“不含元素的集合”
>
- 所有的空集放在一起，做成一个集合的集合，这个“类”，记为符合：0
>
- 把与集合{0}等价的所有集合放在一起，做成一个集合的集合，这个类，记为符合：1
>
- 把与集合{0,1}等价的所有集合放在一起，做成一个集合的集合，这个类，记为符合：2
>
- ......
>
- 把与集合{0,1,2,...,n}等价的所有集合放在一起，做成一个集合的集合，这个类，记为符合：n+1
>
### 归纳定义
>
- 这样，**弗雷格**从空集出发，仅仅用到集合及集合等价的概念，就把全部非负整数定义出来了。
>
- 全部数学可以建立在集合论的基础上了。
>
- 罗素把他发现的悖论写信给弗雷格，
>
- 弗雷格在《算术基础》一书的末尾，无可奈何地写道：“一个科学家遇到的最不愉快的事莫过于，当他的工作完成时，基础崩塌了。当本书即将印刷时，罗素先生的一封信就使我陷入这样的尴尬境地。”
>
### 集合论中居然有逻辑上的矛盾
>
- 算术的基础动摇了，整个数学的基础似乎也动摇了。这样的动摇带来的震撼是空前的。“我们的数学就是建立在这样的基础上吗？”
>
## 7 罗素悖论与悖论的消除
>
- 一个集合或者是他本身的成员，或者不是他本身的成员，两者必居其一。
>
- 异常集合：集合是其本身的成员
- 正常集合：集合不是其本身的成员
>
- “所有抽象概念的集合”本身是一个抽象集合，它是“所有抽象概念的集合”的成员，是“异常集合”
>
- “所有人的集合”不是人，不是“所有人的集合”的成员，是“正常集合”
>
- “所有集合的集合”本身是一个集合，是“异常集合”
>
### 罗素自己当年举出的“异常集合”的例子有两个：
>
- 1 不多于29个字母表达的句子所构成的集合。
>
- 2 不是麻雀的东西所构成的集合。
>
### 罗素悖论
...
- N:不是其本身成员的所有集合的集合
>
- 问：集合N 是否是其本身的成员？集合N 是否是“异常集合”？
>
#### 两种情形：N 是它本身的成员， N 不是它本身的成员
>
- N ∈ N → N ∈ M → N ∉ N
>
- N ∉ N → N ∈ N （N ∉ M）
...
- 要消除罗素悖论，先要了解罗素悖论的症结。
>
- 罗素悖论的实质或者说悖论的共同特征，是“**自我指谓**”。
>
#### 一个待定义的概念，用了包含该概念在内的一些概念来定义，造成恶性循环。例如
>
- 本句话是七个字。涉及自我指谓
>
- 本句话不是七个字。涉及自我指谓
...
- 一种是抛弃集合论；另一种是改造集合论。
>
- 例如，不允许出现“所有集合的集合”、“一切属于自身的集合”这样的集合。
>
- 公理化思想将康托的“朴素集合论”加以公理化。
>
- 策梅洛   Z-系统
>
- 弗兰克尔 ZF-系统
...
### ZFC-系统
>
- Z代表策梅洛，F代表弗兰克尔，C代表选择公理。
>
- 完成了由朴素集合论到公理集合论的发展过程，悖论消除了。
>
- 新的公理化集合论系统的相容性并未证明。
>
- **为了防狼，羊群已经用篱笆圈起来了，但却不知道圈内有没有狼。**——庞加莱
>
- 第三次数学危机的解决并不令人满意。
>
### 三次数学危机都与无穷有关。
>
#### 第一次数学危机的要害是不认识无理数。而无理数是无限不循环小数。
>
#### 第二次数学危机的要害，是极限理论的逻辑基础不完善。
>
#### 第三次数学危机的要害，是人们犯了“自我指谓”、恶性循环的错误。
>
